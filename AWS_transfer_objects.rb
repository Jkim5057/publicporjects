...
MyLog.log.info "Sending #{obj_key} from #{bucket_origin} to #{bucket_destination}"
puts "Response: #{resp}"
MyLog.log.info "Response: #{resp}"
puts "Send Object(s) to Bucket (#{bucket_destination}):"
MyLog.log.info "Object(s) sent to Bucket (#{bucket_destination}):"
...
MyLog.log.info "Object from bucket (#{bucket_origin}):"
